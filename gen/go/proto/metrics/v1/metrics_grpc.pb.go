...
func (c *metricServiceClient) SetMetrics(ctx context.Context, in *SetMetricsRequest, opts ...grpc.CallOption) (*SetMetricsResponse, error) {
...
func (UnimplementedMetricServiceServer) SetMetrics(context.Context, *SetMetricsRequest) (*SetMetricsResponse, error) {
...
func _MetricService_SetMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricServiceServer).SetMetrics(ctx, req.(*SetMetricsRequest))
	}
