...
type Snapshot interface {
	Save(state map[domain.MetricName]model.Metric) error
	Restore() (map[domain.MetricName]model.Metric, error)
}
...
func (m *MemSnapshot) Save(state map[domain.MetricName]model.Metric) error {
...
func (m *MemSnapshot) Restore() (map[domain.MetricName]model.Metric, error) {
